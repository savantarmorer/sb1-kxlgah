DO $$ 
BEGIN
    -- Fix achievements (missing UPDATE/DELETE)
    ...
    -- Fix daily_rewards (missing INSERT/UPDATE/DELETE)
    ...
    -- Fix items (missing INSERT/UPDATE/DELETE)
    ...
    -- Fix quest_requirements (missing INSERT/UPDATE/DELETE)
    ...
    -- Fix quests (missing INSERT/UPDATE/DELETE)
