...
export class BattleService {
   ...
   */
  private static logger = new Logger('BattleService', LogLevel.DEBUG);
  ...
  public static async handle_battle_results(
    ...
    try {
      ...
      BattleService.circuitBreaker.reset_state();
      ...
      BattleService.circuitBreaker.record_failure(
        'BattleCompletion',
