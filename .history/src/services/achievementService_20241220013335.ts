...
export class AchievementService {
  ...
  static async checkTriggers(
    ...
    console.log('User stats:', { battleStats, userProgress, subjectScores });
    ...
    for (const achievement of achievements || []) {
      ...
      if (!triggerCondition) {
        console.log('No matching trigger condition found for achievement:', achievement.id);
        continue;
      }
      ...
      console.log('Actual value for trigger:', { triggerType, actualValue, required: triggerCondition.value });
      ...
      console.log('Progress calculation:', {
        ...
        progressPercentage,
        actualValue,
        required: triggerCondition.value
      });
      ...
      console.log('Unlock evaluation:', {
        shouldUnlock,
        alreadyUnlocked: !!achievement.user_achievements?.[0]?.unlocked_at
      });
