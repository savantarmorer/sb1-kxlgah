 ...
 */
export interface BaseBattleState extends CommonBattleState {
...
/**
 * Battle State With Metadata Interface
 * Extends BattleState with multiplayer-specific metadata
 * Used for multiplayer battle synchronization and state management
 * 
 * @extends BattleState
 */
export interface BattleStateWithMetadata extends BattleState {
  metadata: BattleMetadata & {
    multiplayer: MultiplayerMetadata;
    player_states: Record<string, BattlePlayerState & {
      connection_status: 'connected' | 'disconnected';
