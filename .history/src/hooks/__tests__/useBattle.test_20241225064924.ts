...
jest.mock('../../contexts/GameContext', () => ({
  ...
  GameProvider: ({ children, initialState, skipInitialLoad }: { children: React.ReactNode, initialState?: any, skipInitialLoad?: boolean }) => {
    return children;
  }
}));
...
const Wrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <AuthProvider>
      <GameProvider initialState={mockGameState} skipInitialLoad={true}>
