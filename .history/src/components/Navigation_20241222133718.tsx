...
export default function Navigation({ currentView, onViewChange, isAdmin }: NavigationProps) {
  ...
  const fetchUserTitle = async () => {
    ...
    try {
      ...
      const userDisplayTitle = titleData as UserDisplayTitle;

      if (userDisplayTitle?.display_titles) {
            ...
            <Box sx={{ 
              ...
              <Box>
                <Button
                  ...
                  onClick={handleMenu}
                  startIcon={
                    (state.user as SupabaseUser).user_metadata?.avatar_url ? (
                      <Avatar 
                        src={(state.user as SupabaseUser).user_metadata.avatar_url} 
                ...
                >
                  ...
                  >
                    {(state.user as SupabaseUser).user_metadata?.username || 'User'}
                  </Typography>
                </Button>
                <Menu
                  anchorEl={anchorEl}
