...
export default function EnhancedVisualEditor() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 relative pt-16">
      {/* Back button */}
      ...
      {/* Toolbar */}
      <div className="bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 sticky top-16 z-40">
      ...
      <div className="flex flex-1 h-[calc(100vh-10rem)] mt-4">
        {/* Component Library */}
