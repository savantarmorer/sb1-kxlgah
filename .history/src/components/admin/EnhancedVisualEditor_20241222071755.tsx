...
type ComponentType = 'container' | 'component' | 'layout';
...
export default function EnhancedVisualEditor() {
  ...
  return (
    <div className="min-h-full bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 relative">
      {/* Back button - only show when not in admin dashboard */}
      {window.location.pathname === '/achievements/editor' && (
      ...
      {/* Title - only show when not in admin dashboard */}
      {window.location.pathname === '/achievements/editor' && (
      ...
      {/* Toolbar */}
      <div className={`bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 sticky ${window.location.pathname === '/achievements/editor' ? 'top-16' : 'top-0'} z-40`}>
        <div className="flex items-center space-x-4 overflow-x-auto max-w-full px-4">
          <Button
            variant="outline"
      ...
      <div className={`flex flex-1 ${window.location.pathname === '/achievements/editor' ? 'h-[calc(100vh-10rem)]' : 'h-[calc(100vh-14rem)]'} mt-4`}>
        {/* Component Library */}
            ...
            <div className="space-y-2">
              {availableComponents.map(component => (
                <div
                  ...
                  draggable
                  onDragStart={(e) => {
                    e.dataTransfer.setData('componentType', component.type as string);
                  }}
        ...
        <div
          ref={canvasRef}
          className="flex-1 relative overflow-auto bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700"
          onDrop={handleDrop}
