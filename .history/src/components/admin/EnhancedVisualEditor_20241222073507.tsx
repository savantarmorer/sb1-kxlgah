...
export function EnhancedVisualEditor() {
  ...
  return (
    ...
    >
      ...
      {/* Properties Panel */}
      <div 
        className={`fixed right-4 top-16 w-64 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg pointer-events-auto transition-opacity duration-200 ${isActive && showPropertiesPanel && selectedComponent ? 'opacity-100' : 'opacity-0'}`}
