...
import { Code, Save, Eye, EyeOff, Grid as GridIcon, Settings, X, Keyboard, Plus, Link, Layers, Move, Play, Zap } from 'lucide-react';
...
export function EnhancedVisualEditor() {
  ...
  const renderCodeEditor = () => {
    ...
    return (
      <div 
        className="fixed right-72 top-16 w-96 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg pointer-events-auto"
