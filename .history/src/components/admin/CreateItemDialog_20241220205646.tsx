...
const ITEM_ICONS = {
  weapons: [
    { name: 'icon:sword', icon: Icons.GavelOutlined },
    { name: 'icon:shield', icon: Icons.ShieldOutlined },
    { name: 'icon:bow', icon: Icons.GpsFixedOutlined },
    { name: 'icon:staff', icon: Icons.AutoFixHighOutlined },
    { name: 'icon:axe', icon: Icons.HandymanOutlined },
    { name: 'icon:dagger', icon: Icons.ContentCutOutlined },
  ],
  armor: [
    { name: 'icon:helmet', icon: Icons.Face3Outlined },
    { name: 'icon:chestplate', icon: Icons.SecurityOutlined },
    { name: 'icon:boots', icon: Icons.DirectionsRunOutlined },
    { name: 'icon:gloves', icon: Icons.PanToolOutlined },
    { name: 'icon:ring', icon: Icons.CircleOutlined },
    { name: 'icon:amulet', icon: Icons.DiamondOutlined },
  ],
  consumables: [
    { name: 'icon:potion', icon: Icons.LocalDrinkOutlined },
    { name: 'icon:scroll', icon: Icons.DescriptionOutlined },
    { name: 'icon:food', icon: Icons.RestaurantOutlined },
    { name: 'icon:book', icon: Icons.MenuBookOutlined },
    { name: 'icon:crystal', icon: Icons.DiamondOutlined },
    { name: 'icon:elixir', icon: Icons.ScienceOutlined },
  ],
  magic: [
    { name: 'icon:wand', icon: Icons.AutoFixHighOutlined },
    { name: 'icon:orb', icon: Icons.BlurOnOutlined },
    { name: 'icon:rune', icon: Icons.GradeOutlined },
    { name: 'icon:spell', icon: Icons.AutoAwesomeOutlined },
    { name: 'icon:enchant', icon: Icons.AutoFixNormalOutlined },
  ],
  tools: [
    { name: 'icon:pickaxe', icon: Icons.HandymanOutlined },
    { name: 'icon:fishing_rod', icon: Icons.PhishingOutlined },
    { name: 'icon:hammer', icon: Icons.GavelOutlined },
    { name: 'icon:compass', icon: Icons.ExploreOutlined },
  ],
  special: [
    { name: 'icon:key', icon: Icons.VpnKeyOutlined },
    { name: 'icon:chest', icon: Icons.Inventory2Outlined },
    { name: 'icon:map', icon: Icons.MapOutlined },
    { name: 'icon:crown', icon: Icons.WorkspacePremiumOutlined },
    { name: 'icon:trophy', icon: Icons.EmojiEventsOutlined },
    { name: 'icon:gift', icon: Icons.CardGiftcardOutlined },
  ],
};
