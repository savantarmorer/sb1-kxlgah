                ...
                <Grid item xs={3}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      required
                    >
                      <MenuItem value={QuestType.BATTLE}>Win Battles</MenuItem>
                      <MenuItem value={QuestType.PURCHASE}>Purchase Item</MenuItem>
                      <MenuItem value={QuestType.LOGIN}>Log In</MenuItem>
