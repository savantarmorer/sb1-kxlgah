...
export function BattleMode({ on_close }: BattleModeProps) {
  ...
  type ValidBattleStatus = typeof validBattleStatuses[number];

  const isBattleStatus = (status: string): status is ValidBattleStatus => {
    return validBattleStatuses.includes(status as ValidBattleStatus);
  };
