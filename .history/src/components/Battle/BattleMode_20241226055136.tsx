    ...
    if (phase === BattlePhase.CARD_SELECTION && selectedCard) {
      ...
      if (playerCard) {
        ...
        setTimeout(() => {
          ...
          // Let useBattle handle the phase transition and question setup
          setCurrentQuestion(question);
          startQuestionTimer();
        }, 500);
      }
    }
  }, [phase, selectedCard, playerHand, selectOpponentCard, state.battle, showError, setCurrentQuestion, startQuestionTimer, resetQuestionTimer]);
