...
import { Container, Box, Typography, AnimatePresence, motion } from '@mui/material';
import { BattleHeader, BattleFooter, BattleArena, BattleCard, BattleActions, BattleTimer, CardDisplay, QuestionDisplay, BattleResults, BattleAnimation, Confetti } from '../../components/Battle';
            ...
            <Box sx={{ 
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <BattleActions
                  ...
                  onReady={handleReady}
                  disabled={!playerState.selectedCard}
                />
              </Box>
