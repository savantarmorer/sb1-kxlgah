...
export function BattleMode({ on_close }: BattleModeProps) {
  ...
  // Battle state checks
  const battleStatus = {
    isActive: battle_state?.status === 'active',
    isCompleted: battle_state?.status === 'completed',
    isError: battle_state?.status === 'error',
    isWaiting: battle_state?.status === 'waiting',
    isPreparing: battle_state?.status === 'preparing',
    isPaused: battle_state?.status === 'paused'
  };
