...
export const PreBattleLobby: React.FC<PreBattleLobbyProps> = ({
  ...
  const { state, dispatch, initializeBattle } = useBattle();
  ...
  useEffect(() => {
    ...
    if (searching) {
      timeoutId = setTimeout(() => {
        ...
        // Initialize battle with bot opponent
        ...
        dispatch({
          ...
          payload: BattleStateEnum.CARD_SELECTION
        });
  ...
  }, [searching, countdown, dispatch, onBattleStart, initializeBattle]);
