          ...
          switch (effect.type) {
            case 'eliminate_wrong_answer':
              ...
              if (currentQuestion) {
                ...
                const wrongAnswers = currentQuestion.options.filter(option => option !== correctAnswer);
                ...
                // Update the question options to eliminate the selected wrong answer
                dispatch({
                  type: 'UPDATE_BATTLE_QUESTION',
                  payload: {
                    question: {
                      ...currentQuestion,
                      options: currentQuestion.options.filter(option => option !== answerToEliminate),
                      eliminated_options: [...(currentQuestion.eliminated_options || []), answerToEliminate]
                    }
                  }
                });
              }
