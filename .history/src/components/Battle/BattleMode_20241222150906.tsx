...
import { BattleQuestion, BattlePhase, BattleStatus, MatchState, BattleStats } from '../../types/battle';
...
export default function BattleMode() {
  ...
  const startMatchmaking = async (options: BattleOptions) => {
    ...
    try {
      ...
      matchmaking.subscribeToMatchUpdates((matchState: MatchState) => {
        if (matchState.status === BattleStatus.MATCHED) {
  ...
  const startBotBattle = async (options: BattleOptions) => {
    try {
