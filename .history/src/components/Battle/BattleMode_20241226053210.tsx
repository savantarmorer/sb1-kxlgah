...
export default function BattleMode({ mode = 'all', difficulty = 'medium', is_bot = true }: BattleModeProps) {
  ...
  }, [phase, selectedCard, opponentSelectedCard, playerHand, selectOpponentCard, setPhase]);

  // Debug render
  console.debug('[BattleMode] Rendering:', { phase, currentQuestion, playerState, opponentState });
