          ...
          switch (effect.type) {
            case 'eliminate_wrong_answer':
              ...
              if (currentQuestion) {
                ...
                // First update the questions
                dispatch({
                  type: 'INITIALIZE_BATTLE',
                  payload: {
                    questions: updatedQuestions,
                    time_per_question: battle_state.time_per_question,
                    opponent: battle_state.opponent
                  }
                });
                // Then set the status back to active
            ...
            case 'battle_hint':
              ...
              if (questionWithHint) {
                const updatedQuestionWithHint = {
                  ...questionWithHint,
                  hint_shown: true
                };
                const questionsWithHint = [...battle_state.questions];
                questionsWithHint[battle_state.current_question] = updatedQuestionWithHint;
                
                // Update the questions with hint
                dispatch({
                  type: 'INITIALIZE_BATTLE',
                  payload: {
                    questions: questionsWithHint,
                    time_per_question: battle_state.time_per_question,
                    opponent: battle_state.opponent
                  }
                });
