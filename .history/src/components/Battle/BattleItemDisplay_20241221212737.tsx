  ...
  const battleItems = items.filter(item => {
    ...
    const hasBattleEffects = 
      ...
      (!Array.isArray(effects) && effects && typeof effects === 'object' && (
        ('type' in effects && typeof effects.type === 'string' && isBattleEffect(effects.type)) ||
        ('boostType' in effects && typeof effects.boostType === 'string' && effects.boostType === 'battle') ||
        ('metadata' in effects && typeof effects.metadata === 'object' && effects.metadata?.battle_only) ||
        ('battle_only' in effects && typeof effects.battle_only === 'boolean' && effects.battle_only)
      ));
