...
export default function BattleMode({ mode = 'all', difficulty = 'medium', is_bot = true }: BattleModeProps) {
      ...
      if (playerCard) {
        ...
        const timer = setTimeout(async () => {
          try {
            ...
            await setPhaseWithValidation(BattleStateEnum.CARD_REVEAL);
            
            // Then after delay, transition to QUESTION
  ...
  }, [phase, selectedCard, playerHand, selectOpponentCard, setPhaseWithValidation, showError, t]);
        ...
        <AnimatePresence mode="wait">
          {phase === BattleStateEnum.PREPARING && (
            <PreBattleLobby
              ...
              selectedMode={mode}
              setPhaseWithValidation={setPhaseWithValidation}
              showError={showError}
            />
          )}
