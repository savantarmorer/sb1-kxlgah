...
export function BattleAnimation({ 
  ...
  const getAttackerAnimation = () => ({
    initial: { x: attacker === 'player' ? -200 : 200, opacity: 0 },
    animate: {
      x: [
        0,
        attacker === 'player' ? 300 : -300,
        attacker === 'player' ? -200 : 200
      ],
      opacity: [1, 1, 1],
      scale: [1, 1.5, 1],
      rotate: [0, attacker === 'player' ? 720 : -720, 0],
      transition: {
        duration: 1.4,
        times: [0, 0.5, 1],
        ease: [
