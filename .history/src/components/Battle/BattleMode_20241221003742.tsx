  ...
  return (
    <Box sx={{ 
                ...
                <CardContent>
                  ...
                  {isBattleActive && current_question && (
                    <>
                      <Box sx={{ mb: 4 }}>
                        <Timer
                          time={battle_state?.time_left || 0}
                          total={battle_state?.time_per_question || 0}
                        />
                      </Box>
                  ...
                  {isBattleCompleted && (
                    ...
                    <BattleResults
                      results={{
                        victory: (battle_state?.score?.player || 0) > (battle_state?.score?.opponent || 0),
                        draw: (battle_state?.score?.player || 0) === (battle_state?.score?.opponent || 0),
                        score: battle_state?.score || { player: 0, opponent: 0 },
                        rewards: {
                          xp_earned: rewards.xp_earned,
                          coins_earned: rewards.coins_earned,
                          streak_bonus: rewards.streak_bonus,
      ...
      {show_stats && (
        <Box sx={{ p: 2 }}>
          <ScoreDisplay
            score_player={battle_state?.score?.player || 0}
            score_opponent={battle_state?.score?.opponent || 0}
            streak={state.user?.streak || 0}
