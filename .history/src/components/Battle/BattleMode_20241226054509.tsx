    ...
    if (phase === BattlePhase.CARD_SELECTION && selectedCard) {
      ...
      if (playerCard) {
        ...
        setTimeout(() => {
          ...
          startQuestionTimer(); // Start the timer for the question phase
        }, 500);
      }
    }
  }, [phase, selectedCard, playerHand, selectOpponentCard, setPhase, state.battle, showError, setCurrentQuestion, startQuestionTimer]);
