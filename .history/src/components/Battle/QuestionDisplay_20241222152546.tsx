        ...
        {['a', 'b', 'c', 'd'].map((answer) => (
          ...
          >
            <Button
              ...
              disabled={!!selected_answer || (question.eliminated_options?.includes(answer) ?? false)}
              sx={{
                p: 2,
                height: 'auto',
                display: 'flex',
                ...
                textDecoration: question.eliminated_options?.includes(answer) ? 'line-through' : 'none',
                bgcolor: question.eliminated_options?.includes(answer) ? 'grey.300' : 'primary.main',
                color: question.eliminated_options?.includes(answer) ? 'text.disabled' : 'white',
                pointerEvents: question.eliminated_options?.includes(answer) ? 'none' : 'auto',
              }}
            >
              <Box sx={{ flex: 1 }}>
                <Typography 
