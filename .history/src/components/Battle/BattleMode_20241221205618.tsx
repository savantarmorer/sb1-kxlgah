                      ...
                      <Card sx={{ 
                        ...
                        <CardContent sx={{ p: 4, position: 'relative' }}>
                          <Box sx={{ display: 'flex', gap: 2 }}>
                            ...
                            <Box sx={{ flex: 1 }}>
                              <QuestionDisplay
                                question={battle_state && battle_state.current_question >= 0 && battle_state.current_question < battle_state.questions.length
                                  ? battle_state.questions[battle_state.current_question]
                                  : undefined}
