...
const attackerVariants: Variants = {
  initial: (isPlayer: boolean) => ({
    x: isPlayer ? -200 : 200,
    opacity: 0
  }),
...
const defenderVariants: Variants = {
  initial: (isPlayerAttacking: boolean) => ({
    x: isPlayerAttacking ? 200 : -200,
    opacity: 0
  }),
  animate: (isPlayerAttacking: boolean) => [
    { 
      x: 0, 
      opacity: 1,
      transition: { duration: 0.3 }
    ...
    { 
      x: [0, isPlayerAttacking ? 50 : -50, 0],
      y: [0, -30, 0],
      rotate: [0, isPlayerAttacking ? 15 : -15, 0],
      scale: [1, 0.9, 1],
      transition: { 
        duration: 0.4, 
        delay: 0.7,
...
const ParticleExplosion = ({ color, side = 'right' }: { color: string; side?: 'left' | 'right' }) => {
            ...
            {damage > 0 && (
              <>
                ...
                <ParticleExplosion 
                  ...
                  side={attacker === 'player' ? 'right' : 'left'} 
                />
              </>
            )}
          </Box>
