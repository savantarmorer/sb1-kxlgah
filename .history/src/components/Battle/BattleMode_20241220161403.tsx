...
const createEnhancedBattleState = (
  ...
  const defaultMetadata: BattleMetadataType = {
    is_bot: false,
    questions: [],
    current_question: 0,
  ...
  const metadata: BattleMetadataType = {
    ...defaultMetadata,
...
export function BattleMode({ on_close }: BattleModeProps) {
  ...
  // Battle state checks
  const battleStatus = {
    isActive: battle_state?.status === ('active' as BattleStatus),
    isCompleted: battle_state?.status === ('completed' as BattleStatus),
    isError: battle_state?.status === ('error' as BattleStatus),
    isWaiting: battle_state?.status === ('waiting' as BattleStatus),
    isPreparing: battle_state?.status === ('preparing' as BattleStatus),
    isPaused: battle_state?.status === ('paused' as BattleStatus)
  };
