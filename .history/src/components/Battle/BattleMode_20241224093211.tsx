...
import { BattleState, BattlePhase, PlayerState } from '../../types/battle';
      ...
      <Box sx={{ minHeight: '100vh', py: 4 }}>
        <AnimatePresence mode="wait">
          ...
          {battleState.status === 'completed' && (
            <BattleResults
              winner={battleState.winner === user?.id}
        ...
        <BattleFooter
          battleStats={{
            ...
            rating: user?.battleRatings?.rating || BATTLE_CONFIG.matchmaking.default_rating
          }}
