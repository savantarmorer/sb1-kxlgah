...
export default function BattleMode({ mode = 'all' }: BattleModeProps) {
  ...
  const [phase, setPhase] = useState<string>(BattlePhase.PREPARING);
        ...
        <AnimatePresence mode="wait">
          ...
          {(phase === 'CARD_SELECTION' || phase === 'CARD_REVEAL') && (
            <Box sx={{ 
              ...
              {/* Left Column - Opponent Profile and Hand */}
              <Box sx={{ 
                display: 'flex', 
                flexDirection: 'column', 
                alignItems: 'center', 
              {/* Left Column - Opponent Profile */}
              ...
              <Box sx={{ 
                ...
                <Box sx={{ 
                  ...
                  {/* Opponent Selected Card (always face down) */}
                  <Box sx={{ 
                    width: CARD_WIDTH,
                    height: 160,
              ...
              {/* Opponent's Hand - Always face down */}
              <Box sx={{ 
                position: 'absolute',
                top: 32,
                left: 0,
              ...
              <Box sx={{ 
                ...
                <Box sx={{ 
                  ...
                  <BattleHand
                    cards={playerHand.slice(0, 3)} // Only show 3 cards
