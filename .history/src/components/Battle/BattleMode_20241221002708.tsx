...
export function BattleMode({ on_close }: BattleModeProps) {
  ...
  }, [handle_item_effect, showError, t, useItem]);
    ...
    <Box sx={{ 
                ...
                <CardContent>
                  ...
                  {isBattleActive && current_question && (
                    <>
                      <Box sx={{ mb: 4 }}>
                        <Timer
                          duration={battle_state?.time_left || 0}
                          isRunning={isBattleActive}
                        />
                      </Box>
                      <QuestionDisplay
                        question={current_question}
                        onAnswerSelected={handle_answer_selection}
                  ...
                  {isBattleCompleted && (
                    <BattleResultsComponent
                      ...
                      rewards={rewards}
                      onClaim={handle_battle_completion}
      ...
      {show_stats && (
        <Box sx={{ p: 2 }}>
          <ScoreDisplay
            score={battle_state?.score || { player: 0, opponent: 0 }}
            total={battle_progress.total_questions}
          />
        </Box>
      )}
