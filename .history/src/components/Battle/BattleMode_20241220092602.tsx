...
const castBattleState = (state: BattleState | null): ExtendedBattleState | null => {
  ...
  const currentPhase = (metadata?.phase as BattlePhaseType) || BattlePhases.waiting;
  
  return {
    ...rest,
    phase: currentPhase,
    player_answers: rest.player_answers || [],
    status: rest.status || 'idle',
    score: rest.score || { player: 0, opponent: 0 },
    time_left: rest.time_left || 0,
