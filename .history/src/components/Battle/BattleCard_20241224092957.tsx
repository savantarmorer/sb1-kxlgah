...
import { Sword, Shield, Gavel, Zap } from 'lucide-react';
...
const ACTION_ICONS: Record<string, React.ReactNode> = {
  'attack': <Sword size={32} />,
  'defense': <Shield size={32} />,
  'counter': <Gavel size={32} />,
  'special': <Zap size={32} />
};

const ACTION_COLORS: Record<string, string> = {
  'attack': '#FF4081', // Pink for attack
  'defense': '#2196F3', // Blue for defense
  'counter': '#FF9800', // Orange for counter
  'special': '#9C27B0'  // Purple for special
};

export function BattleCard({ isFlipped, isWinner, action, power = 0, effect }: BattleCardProps) {
