...
function LootboxModel({ 
  ...
  useEffect(() => {
    if (materials.Material) {
      materials.Material.color.set(colors.primary);
      materials.Material.emissive.set(colors.emissive);
      materials.Material.emissiveIntensity = emissiveIntensity;
      materials.Material.metalness = 0.7;
      materials.Material.roughness = 0.2;
      materials.Material.envMapIntensity = 1.5;
    }
