...
const SettingsEditor: React.FC<{
  ...
  const renderNumberInput = (label: string, path: string[], min?: number, max?: number, step?: number) => (
    <div className="flex items-center gap-2 mb-2">
      <label className="text-sm w-32 text-gray-300">{label}</label>
      <input
        type="number"
        value={String(path.reduce((obj, key) => obj[key as keyof typeof obj], settings as any))}
        onChange={(e) => updateSetting(path, parseFloat(e.target.value))}
  ...
  const renderColorInput = (label: string, path: string[]) => (
    <div className="flex items-center gap-2 mb-2">
      ...
      <input
        type="color"
        value={path.reduce((obj, key) => obj[key as keyof typeof obj], settings as any)}
        onChange={(e) => updateSetting(path, e.target.value)}
        className="bg-transparent w-24 h-8"
      />
    </div>
  );
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, x: 20 }}
            className="absolute top-12 right-0 bg-gray-900 text-white p-4 rounded-lg shadow-lg w-80 max-h-[80vh] overflow-y-auto"
          >
            <h3 className="text-lg font-bold mb-4">Scene Settings</h3>
            
            <div className="space-y-6">
              <div>
                <h4 className="text-md font-semibold mb-2">Model</h4>
              ...
              <div>
                <h4 className="text-md font-semibold mb-2">Camera</h4>
              ...
              <div>
                <h4 className="text-md font-semibold mb-2">Animation</h4>
              ...
              <div>
                <h4 className="text-md font-semibold mb-2">Orb</h4>
              ...
              <div>
                <h4 className="text-md font-semibold mb-2">Bloom</h4>
              ...
              <div>
                <h4 className="text-md font-semibold mb-2">Legendary Sequence</h4>
