...
export function PremiumRewards() {
  ...
  // Store user in a constant to help TypeScript with type narrowing
  ...
  const handlePurchase = async (reward: PremiumReward) => {
    ...
    if (reward.metadata?.requirements?.level && user.level < reward.metadata.requirements.level) {
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between mt-3">
                  ...
                  <Button
                    variant={(user.coins || 0) >= reward.cost ? 'primary' : 'secondary'}
                    size="sm"
                    onClick={() => handlePurchase(reward)}
                    disabled={isProcessing || (user.coins || 0) < reward.cost}
                  >
