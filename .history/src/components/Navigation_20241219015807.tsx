      ...
      {showProfile && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-24 -translate-x-1/2 w-full max-w-5xl mx-auto px-4 z-50"
          >
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden max-h-[calc(100vh-140px)] overflow-y-auto">
