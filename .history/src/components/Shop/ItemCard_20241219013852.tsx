...
import type { ItemEffect, ItemRarity } from '../../types/items';
...
const rarityColors = {
  [ItemRarity.COMMON]: 'neutral.400',
  [ItemRarity.UNCOMMON]: 'success.main',
...
type ColorVariant = 'main' | 'light' | 'dark' | '400';
          ...
          <Box sx={{ textAlign: 'center', mb: 2 }}>
            ...
            {item.item.rarity && (
              <Chip
                ...
                size="small"
                sx={{
                  bgcolor: theme.palette[paletteColor][colorVariant],
                  color: 'white',
                  fontWeight: 'bold',
                }}
              />
