...
export default function DailyRewardSystem(): JSX.Element | null {
  ...
  const DAILY_REWARDS: DailyReward[] = [
    { day: 1, reward: { type: 'xp', value: 100, rarity: ItemRarity.COMMON } },
    { day: 2, reward: { type: 'coins', value: 50, rarity: ItemRarity.COMMON } },
    { day: 3, reward: { type: 'xp', value: 150, rarity: ItemRarity.RARE } },
    { day: 4, reward: { type: 'coins', value: 100, rarity: ItemRarity.RARE } },
    { day: 5, reward: { type: 'xp', value: 250, rarity: ItemRarity.EPIC } },
    { day: 6, reward: { type: 'coins', value: 200, rarity: ItemRarity.EPIC } },
    { day: 7, reward: { type: 'item', value: 500, rarity: ItemRarity.LEGENDARY } }
  ];
  ...
  useEffect(() => {
    if (state.user?.streak > 0) {
      updateStreakMultiplier(state.user.streak);
    }
  ...
  return (
    <div className="space-y-6">
      ...
      <LoginCalendar
        loginDates={state.user.login_history || []}
