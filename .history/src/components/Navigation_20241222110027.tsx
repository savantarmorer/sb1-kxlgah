...
const getTitleStyle = (title: string | undefined) => {
  // These are just example styles - adjust based on your title rarity data
  const titleStyles: Record<string, string> = {
    // Common titles
    'Adventurer': 'text-gray-600 dark:text-gray-400',
    // Rare titles
    'Battle Master': 'text-blue-600 dark:text-blue-400',
    'Quiz Champion': 'text-blue-600 dark:text-blue-400',
    // Epic titles
    'Legal Scholar': 'text-purple-600 dark:text-purple-400',
    'Constitutional Expert': 'text-purple-600 dark:text-purple-400',
    // Legendary titles
    'Supreme Justice': 'text-yellow-600 dark:text-yellow-400',
    'Legal Legend': 'text-yellow-600 dark:text-yellow-400'
  };

  return titleStyles[title || ''] || titleStyles['Adventurer'];
};
            ...
            >
              ...
              >
                ...
                <p className="text-xs font-medium flex items-center gap-1">
                  ...
                  <span className={`font-semibold ${getTitleStyle(state.user?.display_title)}`}>
