      ...
      <div className="relative min-h-screen">
        <main className="max-w-7xl mx-auto px-4 pt-24 pb-28">
          {isLoading ? (
            ...
            <Routes>
              <Route path="/" element={<Navigate to={ROUTE_BASE} replace />} />
              <Route path={ROUTE_BASE} element={<Dashboard />} />
              <Route path={`${ROUTE_BASE}/battle`} element={<BattleMode on_close={handleBattleClose} />} />
              <Route path={`${ROUTE_BASE}/inventory`} element={<InventorySystem />} />
              <Route path={`${ROUTE_BASE}/shop`} element={<ShopSystem />} />
              <Route path={`${ROUTE_BASE}/tournament`} element={<TournamentMode />} />
              <Route path={`${ROUTE_BASE}/achievements`} element={<AchievementsPage />} />
              <Route path={`${ROUTE_BASE}/quests`} element={<QuestSystem />} />
              <Route path={`${ROUTE_BASE}/settings`} element={
