      ...
      {showProfile && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl mx-auto px-4 z-[100]"
          >
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow-2xl overflow-hidden max-h-[80vh] overflow-y-auto">
