...
const BASE_DECK: Card[] = [
  // Attack cards
  { id: 'atk1', action: BattleActions.ATTACK, power: 3 },
  { id: 'atk2', action: BattleActions.ATTACK, power: 4 },
  { id: 'atk3', action: BattleActions.ATTACK, power: 5 },
  
  // Defense cards
  { id: 'def1', action: BattleActions.DEFENSE, power: 3 },
  { id: 'def2', action: BattleActions.DEFENSE, power: 4 },
  
  // Counter cards
  { id: 'cnt1', action: BattleActions.COUNTER, power: 3 },
  { id: 'cnt2', action: BattleActions.COUNTER, power: 4 }
];
