...
export const SAMPLE_ITEMS: Item[] = [
  {
    id: 'elimination-potion-1',
    name: 'Elimination Potion',
    description: 'Eliminates one wrong answer during battle',
  ...
  {
    id: 'elimination-potion-2',
    name: 'Greater Elimination Potion',
    description: 'Eliminates two wrong answers during battle',
    type: ItemType.CONSUMABLE,
    ...
    imageUrl: '/images/items/potion-red.png'
  },
  {
    id: 'xp-boost-1',
    name: 'Minor XP Boost',
