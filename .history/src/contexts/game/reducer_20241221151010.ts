...
import type { BattleStatus, BattlePhase, BattlePlayerState, BattleMetadata } from '../../types/battle';
...
const initialBattleState = {
  ...
  player_states: {} as Record<string, BattlePlayerState>,
  started_at: null,
    ...
    case 'INITIALIZE_BATTLE':
      ...
      return {
        ...
        battle: {
          ...
          status: 'active',
          score: { player: 0, opponent: 0 },
          phase: 'in_progress' as BattlePhase,
