...
export type GameAction =
  ...
  | { type: 'PLAY_CARD'; payload: { playerCard: Card; opponentCard: Card; score: BattleScore } }
  | { type: 'UPDATE_BATTLE_PROGRESS'; payload: { playerCard?: Card; opponentCard?: Card; score: BattleScore; current_round: number; last_played_cards: { player: Card; opponent: Card } } }
