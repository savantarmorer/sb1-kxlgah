...
export const GameProvider: React.FC<GameProviderProps> = ({ 
  ...
  useEffect(() => {
    ...
    const handleVisibilityChange = async () => {
      if (document.visibilityState === 'visible' && state.user?.id) {
        ...
        try {
          ...
          if (gameState && gameState.user) {
            ...
            // First reset battle state to ensure clean slate
            dispatch({ type: 'RESET_BATTLE' });
            
            // Initialize user with complete data
            dispatch({ type: 'INITIALIZE_USER', payload: gameState.user });
            
            // Initialize battle if exists
