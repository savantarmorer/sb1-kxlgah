...
import type { BattleStatus, BattleRewards } from '../types/battle';
...
export const GameProvider: React.FC<GameProviderProps> = ({ 
  ...
  const getBattleStatus = (): BattleStatus => {
    return state.battle?.status || BattleStateEnum.IDLE;
  };
  ...
  const getBattleProgress = () => {
    ...
    return {
      ...
      current_round: state.battle.current_round,
      total_rounds: state.battle.total_rounds
    };
  };
