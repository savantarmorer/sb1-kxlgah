...
DROP VIEW IF EXISTS public.v_shop_items;
DROP VIEW IF EXISTS public.v_shop_avatars;
...
CREATE VIEW public.v_shop_avatars AS
SELECT 
    a.id,
    a.name,
...
-- Create shop items view
CREATE VIEW public.v_shop_items AS
SELECT 
    si.id,
    si.item_id,
    si.price,
